  ...
  Utils = {
    ...
    make: function () {
      ...
      routes = {
        ...
        // function(handle, options)
        followers_you_know_path: Utils.route(
          [
            ["handle", true],
            ["format", false],
          ],
        ...
        // function(options)
        follows_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // likes => /likes(.:format)
        // function(options)
        likes_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        new_retweet_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        new_session_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        new_tweet_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        new_user_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(handle, options)
        profile_likes_path: Utils.route(
          [
            ["handle", true],
            ["format", false],
          ],
        ...
        // function(handle, options)
        profile_media_path: Utils.route(
          [
            ["handle", true],
            ["format", false],
          ],
        ...
        // function(handle, options)
        profile_with_replies_path: Utils.route(
          [
            ["handle", true],
            ["format", false],
          ],
        ...
        // function(options)
        retweets_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        search_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        sessions_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        signup_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        tweets_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // users => /users(.:format)
        // function(options)
        users_path: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
